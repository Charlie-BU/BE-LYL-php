$(function() {
	...
	function webuploader(opts){
		...
		uploader.on( 'uploadSuccess', function( file,data) {
			...
			if(data.state == 'SUCCESS'){
				...
				sLi += '<img src="' + data.url + '" width="100" height="100" onerror="this.src=\'/resource/images/nopic.png\'">';
	...
	window.Manager = {
		...
		upload : function(opts){
			...
			if(type == 'Images'){
				...
				this.opts.accept = {
					...
					extensions : 'mp4,3gp,gif,jpg,jpeg,bmp,png',

					mimeTypes : 'video/*,image/gif,image/jpg,image/jpeg,image/png,image/bmp'
				}
		...
		del:function(obj){
		    ...
		    $.get(this.opts.delPath,{action:"del", filename:$(obj).attr('data-img')},function(res){
					if(res == 1){
