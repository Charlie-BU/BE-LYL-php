...
class WxPayConfig
{
    ...
    public function getSslPaths(){
    	 ...
    	 return [
             'weixin' => ['ssl_cert' => $realPath . DIRECTORY_SEPARATOR . 'cert' . DIRECTORY_SEPARATOR . 'apiclient_cert.pem', 'ssl_key' => $realPath . DIRECTORY_SEPARATOR . 'cert' . DIRECTORY_SEPARATOR . 'apiclient_key.pem'],
